             ...
             <div class="teacher-info">
               ...
               <div class="teacher-content">
                 <div class="cont1">
                   ...
                   <div class="name">
                     <p class="teacher-name">Tiger</p>
                     <p class="teacher-title">Linux学科带头人</p>
                   </div>
                 </div>
                 <p class="narrative" >这里是讲师自我介绍，看着自己介绍介绍就行</p>
               </div>
             </div>
          </div>
        </div>
...
const options = reactive({
  source: require("/src/assets/1.mp4"),
  cover: require("/src/assets/course-1.png"),
  autoplay: false,
  preload: true,
