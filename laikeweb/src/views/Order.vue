...
<!--                <i :class="order.use_coupon?'el-icon-arrow-up':'el-icon-arrow-down'" @click="order.use_coupon=!order.use_coupon"></i>-->
        ...
        <div class="pay-type">
          ...
          <div class="list">
            <img :src="order.pay_type==0?'../assets/alipay2.png':'../assets/alipay1.png'" @click="order.pay_type=0" alt="支付宝">
            <img :src="order.pay_type==1?'../assets/wechat2.png':'../assets/wechat1.png'" @click="order.pay_type=1" alt="微信">
            <img :src="order.pay_type==2?'../assets/yue2.png':'../assets/yue1.png'"  @click="order.pay_type=2" alt="余额">
          </div>
        </div>
