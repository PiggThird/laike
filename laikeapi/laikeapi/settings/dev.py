"""
Django settings for laikeapi project.
...
SECRET_KEY = 'django-insecure-h%=b0+ct=wwu11e63gu&k9!v3wu-4ax+*#o5^(^!dqkm%c^l%3'
...
WSGI_APPLICATION = 'laikeapi.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理流程，console或者mail_admins都是自定义的。
        ...
        'file': {
            ...
            'filename': BASE_DIR.parent / "logs/laike.log",
...
CELERY_BEAT_SCHEDULE = {
    "user-send_sms": {  # 定时任务的注册标记符[必须唯一的]
        "task": "send_sms",   # 定时任务的任务名称
