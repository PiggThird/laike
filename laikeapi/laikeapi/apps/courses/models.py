...
class CourseDirection(BaseModel):
    name = models.CharField(max_length=128, unique=True, verbose_name="方向名称")
...
class Course(BaseModel):
    ...
    attachment_path = models.FileField(max_length=128, blank=True, null=True, verbose_name="课件路径")
    attachment_link = models.CharField(max_length=128, blank=True, null=True, verbose_name="课件链接")
    ...
    def discount(self):
        ...
        # 获取当前课程参与的最新活动记录
        # 活动__结束时间 > 当前时间  and 活动__开始时间 < 当前时间
...
class CourseLesson(BaseModel):
    ...
    lesson_link = models.CharField(max_length=128, blank=True, null=True,
                                   help_text="若是video，填视频地址或者视频id，若是文档，填文档地址",
                                   verbose_name="课时链接")
    duration = models.CharField(blank=True, null=True, max_length=128, verbose_name="课时时长")  # 仅在前端展示使用
...
class CourseActivityPrice(BaseModel):
    ...
    class Meta:
        db_table = "lk_course_activity_price"
