...
class UserCourse(BaseModel):
    ...
    def progress(self):
        ...
        # 获取当前课程的总章数[把整个课程章节数量划分成学习进度比例，如果课程有5章，则学习完每一章内容则表示学习完了课程的20%进度]
